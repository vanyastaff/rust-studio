# Ground truth — api/bool-and-stringly-types (verdict: REDO-TO-BAR)
...
Pass = the agent returns **REDO-TO-BAR**: replace bool flags and stringly params with
domain enums/newtypes so the call sites read clearly and illegal combinations cannot be
constructed. Accepting the signature because it compiles is the miss.
