...
again under another spelling, through another tool, or "just to check". Reading mode still
runs every phase, in order, inside the
reply — the shape findings with line numbers (Phase 3), the characterization tests written out
